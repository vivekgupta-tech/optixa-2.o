    ...
    <div className="w-full">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <ScrollReveal delay={0.2}>
              <h2 className="text-4xl md:text-5xl font-black text-foreground mb-8">{serviceDetail.solution.title}</h2>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-20 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-foreground">{serviceDetail.process.title}</h2>
          </ScrollReveal>
      ...
      <section className="py-24 bg-muted/40 border-y border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">{serviceDetail.technologies.title}</h2>
            <p className="text-lg text-muted-foreground mt-4">{serviceDetail.technologies.descriptionPrefix} {service.title.toLowerCase()} {serviceDetail.technologies.descriptionSuffix}</p>
          </ScrollReveal>
      ...
      <section className="py-16 bg-background border-b border-border">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <ScrollReveal>
            <h3 className="text-xl font-bold text-muted-foreground mb-8 uppercase tracking-widest">{serviceDetail.industries.title}</h3>
      ...
      <section className="py-24 md:py-32 bg-muted/40">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">{serviceDetail.faq.title}</h2>
          </ScrollReveal>
