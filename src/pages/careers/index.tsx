    ...
    <div className="w-full">
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-20 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-foreground">Why Join Optixa</h2>
          </ScrollReveal>
      ...
      <section className="py-24 bg-muted border-y border-border">
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">The Perks</h2>
          </ScrollReveal>
      ...
      <section className="relative py-32 bg-sidebar text-sidebar-foreground overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-3xl">
          <ScrollReveal>
            <h2 className="text-4xl md:text-5xl font-black text-sidebar-foreground mb-6" >No Egos. Just Engineering.</h2>
            <p className="text-xl text-sidebar-foreground/90 leading-relaxed" >
      ...
      <section className="py-24 bg-background border-b border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">How We Hire</h2>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto relative">
            ...
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.1} className="relative z-10 bg-background pt-4">
                <div className="w-16 h-16 bg-foreground text-background rounded-full flex items-center justify-center font-black text-2xl mx-auto mb-6 border-4 border-background shadow-sm">
                  {stage.step}
                </div>
      ...
      <section className="py-24 md:py-32 bg-muted">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="max-w-3xl mx-auto text-center bg-background p-12 md:p-16 border border-border shadow-sm rounded-xl">
            ...
            <h2 className="text-3xl font-black text-foreground mb-4">Open Positions</h2>
            ...
            <div className="bg-primary/10 p-6 rounded-lg text-left">
              ...
              <p className="text-muted-foreground mb-4">We are always eager to meet exceptional Senior React/Next.js Engineers and Cloud Architects.</p>
              <a href="mailto:careers@optixa.io" className="text-foreground font-bold flex items-center gap-2 hover:text-primary transition-colors">
