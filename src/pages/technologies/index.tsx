    ...
    <div className="w-full">
      ...
      <section className="py-24 bg-background border-b border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-black text-foreground mb-6">Pragmatic Tech Selection</h2>
      ...
      <section className="py-24 md:py-32 bg-sidebar text-sidebar-foreground">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-20 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-sidebar-foreground mb-6">Architecture Patterns</h2>
            <p className="text-xl text-sidebar-foreground/75 max-w-3xl mx-auto">Tools are only as good as the blueprint. We employ modern architectural paradigms to ensure systems are resilient and scalable.</p>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.1} className="bg-sidebar-accent/50 border border-sidebar-border p-10">
                <div className="text-primary mb-6">{pattern.icon}</div>
                <h3 className="text-2xl font-bold text-sidebar-foreground mb-4">{pattern.title}</h3>
                <p className="text-sidebar-foreground/75 text-lg leading-relaxed">{pattern.desc}</p>
              </ScrollReveal>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-background text-center">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <ScrollReveal>
            <h2 className="text-4xl font-black text-foreground mb-8">Ready to Build?</h2>
            ...
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-sidebar hover:text-sidebar-foreground h-16 px-10 text-lg">
