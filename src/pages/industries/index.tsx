              ...
              <div className="container mx-auto px-4 md:px-8 py-24 md:py-32">
                <div className={cn("grid lg:grid-cols-2 gap-16 items-center", !isEven && "lg:grid-flow-col-dense")}>
                  ...
                  <ScrollReveal delay={0.2} className={cn(isEven ? "lg:col-start-2" : "lg:col-start-1")}>
                    ...
                    <div className="mb-10">
                      <h4 className="text-xl font-bold text-foreground mb-4">{industriesList.labels.keySolutions}</h4>
      ...
      <section className="py-24 md:py-32 bg-muted/40">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-16">
            <h2 className="text-4xl font-black text-foreground">{industriesList.labels.moreSectorsTitle}</h2>
          </ScrollReveal>
      ...
      <section className="py-24 bg-sidebar text-sidebar-foreground text-center">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">{industriesList.cta.description}</p>
