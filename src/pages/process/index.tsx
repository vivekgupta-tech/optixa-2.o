    ...
    <div className="w-full">
      ...
      <section className="py-24 bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-black text-black mb-8">Process That Scales</h2>
      ...
      <section className="py-20 bg-white border-y border-gray-200">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <ScrollReveal>
            <h3 className="text-xl font-bold text-gray-400 uppercase tracking-widest mb-10">Our Workflow Toolkit</h3>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center max-w-5xl mx-auto">
            <ScrollReveal>
              ...
              <p className="font-bold text-sm uppercase tracking-wider text-gray-400">Code Transparency</p>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <p className="text-5xl font-black text-primary mb-2">2 Wks</p>
              <p className="font-bold text-sm uppercase tracking-wider text-gray-400">Sprint Cycles</p>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <p className="text-5xl font-black text-primary mb-2">0</p>
              <p className="font-bold text-sm uppercase tracking-wider text-gray-400">Surprise Costs</p>
            </ScrollReveal>
            <ScrollReveal delay={0.3}>
              <p className="text-5xl font-black text-primary mb-2">24/7</p>
              <p className="font-bold text-sm uppercase tracking-wider text-gray-400">Environment Access</p>
            </ScrollReveal>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-black">Process FAQ</h2>
          </ScrollReveal>
      ...
      <section className="py-24 bg-primary text-center">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-8">Ready to Build Without the Chaos?</h2>
