    ...
    <div className="w-full">
      ...
      <section className="py-24 bg-background border-b border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-black text-foreground mb-8">{processPage.philosophy.title}</h2>
      ...
      <section className="py-24 md:py-32 bg-muted/40 overflow-hidden">
        <div className="container mx-auto px-4 md:px-8">
          <div className="relative max-w-6xl mx-auto">
            {/* The vertical line */}
            <div className="absolute left-[39px] lg:left-1/2 top-0 bottom-0 w-1 bg-muted lg:-ml-[2px]" />
      ...
      <section className="py-20 bg-background border-y border-border">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <ScrollReveal>
            <h3 className="text-xl font-bold text-muted-foreground uppercase tracking-widest mb-10">{processPage.toolkit.title}</h3>
      ...
      <section className="py-24 md:py-32 bg-muted/40">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">{processPage.faq.title}</h2>
          </ScrollReveal>
