      ...
      <section className="py-24 md:py-32 bg-muted/40 border-y border-border">
        <div className="container mx-auto px-4 md:px-8 mb-20 text-center">
          <ScrollReveal>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-foreground">{home.servicesPreview.title}</h2>
          </ScrollReveal>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {[<TerminalSquare />, <Gauge />, <Users />, <Layers />].map((icon, i) => {
              ...
              <ScrollReveal key={i} y={20} delay={i * 0.1} className="group">
                <div className="w-16 h-16 bg-background/5 border border-white/10 flex items-center justify-center text-primary mb-6 transition-colors group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary">
      ...
      <section className="py-24 bg-muted/40 border-y border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">{home.technologies.title}</h2>
          </ScrollReveal>
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-foreground">{home.featuredWork.title}</h2>
            <p className="text-xl text-muted-foreground mt-4 max-w-2xl">{home.featuredWork.subtitle}</p>
          </ScrollReveal>
          ...
          <div className="space-y-8">
            ...
            <ScrollReveal className="relative group overflow-hidden bg-[#111] aspect-[16/9] md:aspect-[21/9]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8 md:p-16">
                ...
                <p className="text-lg text-sidebar-foreground/70 max-w-3xl mb-8">{home.featuredWork.topShowcase.desc}</p>
              ...
              {home.featuredWork.bottomShowcases.map((showcase, idx) => (
                <ScrollReveal key={idx} delay={0.1 + (idx * 0.1)} className="relative group overflow-hidden bg-[#111] aspect-square md:aspect-[4/3]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8">
                    <span className="inline-block px-3 py-1 bg-background text-foreground text-xs font-bold tracking-widest uppercase mb-4 self-start">{showcase.tag}</span>
              ...
              <div className="grid sm:grid-cols-2 gap-x-8 gap-y-6">
                {home.industries.items.map((ind, i) => (
                  <Link key={i} href={home.industries.link} className="flex items-center justify-between group border-b border-white/10 pb-4">
                    <span className="text-xl font-bold text-sidebar-foreground/70 group-hover:text-primary-foreground transition-colors">{ind}</span>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <ScrollReveal>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-foreground">{home.insightsPreview.title}</h2>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <Button asChild variant="outline" className="border-2 border-black text-foreground hover:bg-foreground hover:text-primary-foreground">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <Button asChild size="lg" variant="outline" className="border-2 border-white text-white hover:bg-background hover:text-foreground h-16 px-10 text-lg bg-transparent">
