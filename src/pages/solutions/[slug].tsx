      ...
      <section className="bg-muted/40 py-24 md:py-32">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-foreground">{solutionDetail.architecture.title}</h2>
          </ScrollReveal>
      ...
      <section className="py-24 md:py-32 bg-background border-y border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-16 text-center">
            <h2 className="text-4xl md:text-5xl font-black text-foreground">{solutionDetail.benefits.title}</h2>
          </ScrollReveal>
      ...
      <section className="py-24 md:py-32 bg-muted/40">
        <div className="container mx-auto px-4 md:px-8 max-w-4xl">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground">{solutionDetail.faq.title}</h2>
          </ScrollReveal>
