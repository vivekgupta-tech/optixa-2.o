      ...
      <section className="relative pt-40 pb-32 md:pt-56 md:pb-48 bg-sidebar text-sidebar-foreground overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <ScrollReveal className="max-w-4xl">
            <Link href="/insights" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary-foreground transition-colors font-bold text-sm uppercase tracking-wider mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="lg:w-1/4 shrink-0">
              <div className="sticky top-32 space-y-12">
                ...
                {/* Author */}
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">{insightDetail.writtenBy}</h4>
                ...
                {/* Share */}
                <div>
                  <h4 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">{insightDetail.shareArticle}</h4>
                ...
                {/* Services Banner */}
                <div className="bg-muted p-6 border border-border hidden lg:block">
                  <h4 className="font-black text-xl text-foreground mb-2">{insightDetail.banner.title}</h4>
                  <p className="text-sm text-muted-foreground mb-6">{insightDetail.banner.description}</p>
      ...
      <section className="py-24 bg-muted/40 border-t border-border">
        <div className="container mx-auto px-4 md:px-8">
          <ScrollReveal className="mb-16">
            <h2 className="text-3xl font-black text-foreground">{insightDetail.relatedTitle}</h2>
          </ScrollReveal>
